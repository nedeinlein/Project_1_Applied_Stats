...
```{r}
model1 <- lm(Life.expectancy ~ Status + continent + Income.composition.of.resources + Schooling + BMI_log + GDP_log + HIV.AIDS_log, 
             data = lifeExpec_final)
...
model2 <- lm(Life.expectancy ~ Status + Income.composition.of.resources + Schooling + BMI_log + GDP_log + HIV.AIDS_log, 
             data = lifeExpec_final)
