...
num_col_highCorr <- subset(num_col, select = -c(Alcohol, infant.deaths, Hepatitis.B, Measles, under.five.deaths, Total.expenditure, Population, thinness..1.19.years, thinness.5.9.years))

chart.Correlation(num_col_highCorr, histogram=TRUE, pch=19)

```

# Test on transformation on high good candidate variables
